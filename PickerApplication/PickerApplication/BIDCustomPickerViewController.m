...
-(void)playWinSound {
    ...
    AudioServicesCreateSystemSoundID(
                                     (__bridge CFURLRef)
                                     [NSURL fileURLWithPath:path], &soundID);
...
- (void)viewDidLoad
{
    ...
    for (int i = 1; i <= 5; i++) {
        UIImageView *sevenView = [[UIImageView alloc]
                                  initWithImage:seven];
        UIImageView *barView = [[UIImageView alloc]
                                initWithImage:bar];
        UIImageView *crownView = [[UIImageView alloc]
                                  initWithImage:crown];
...
- (void)didReceiveMemoryWarning
{
    ...
    // Release any cached data, images,
